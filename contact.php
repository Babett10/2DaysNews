...
<body>
        ...
        <div class="row">
            ...
            <div class="col-md-7">
                <div class="contact-form bg-light mb-3" style="padding: 30px;">
                    ...
                    <div id="success"></div>
                    <form name="contact-form-berita" id="contactForm" novalidate="novalidate">
                        <div class="form-row">
                            <div class="col-md-6">
                        ...
                        <div class="control-group">
                            <textarea class="form-control p-4 " rows="4" name="message" id="message" placeholder="Message" required="required" data-validation-required-message="Please enter your message"></textarea>
                            <p class="help-block text-danger"></p>
                        </div>
                        <div>
    ...
    <script type="text/javascript">
        // Script Contact Form
        const scriptURL = 'https://script.google.com/macros/s/AKfycbxOb8c0e_uLKUOefOpd-Uh7SqGRXrjrB54BSRU3_YZlmUolYGsZxdtwAmbsPxXSdXXOEA/exec'
        const form = document.forms['contact-form-berita']
