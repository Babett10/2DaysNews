                            ...
                            <div class="position-relative mb-3">
                                ...
                                <div class="overlay position-relative bg-light">
                                    ...
                                    <p class="m-0">MNC Vision resmi menjual sebagian aset jaringan infrastruktur fiber 
                                        to the home (FTTH) dan infrastruktur fixed broadband kepada Asianet.T MNC Vision
                                         Networks Tbk (IPTV) selaku pemilik layanan TV kabel MNC Play, resmi menjual 
                                         sebagian aset jaringan infrastruktur fiber to the home (FTTH), kabel dan 
                                         infrastruktur fixed broadband kepada PT Asianet Media Teknologi.Sementara pelanggan 
                                         PT MNC Kabel Mediacom (MKM) atau subscriber MNC Play, dialihkan kepada PT Indosat Tbk (ISAT). 
                                         Selanjutnya, Indosat akan menggunakan jaringan yang dibeli Asianet itu untuk menggelar layanan
                                         fiber to the home (FTTH), Indosat HiFi.Penjualan sebagian aset jaringan infrastruktur FTTH, 
                                         kabel dan infrastruktur fixed broadband kepada PT Asianet Media Teknologi itu dilaporkan Kontan
                                         dan dikutip KompasTekno, mencapai nilai Rp Rp 2,42 triliun.
                                    </p>
