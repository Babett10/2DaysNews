                        ...
                        <div class="col-lg-12">
                            <div class="position-relative mb-3">
                                ...
                                <div class="overlay position-relative bg-light">
                                    ...
                                    <a class="h4" href="https://tekno.kompas.com/">Tecno Spark 20C Rilis dengan Fitur "Dynamic Island" ala iPhone</a>
                                    <p class="m-0">Tecno Spark 20C Rilis dengan Fitur "Dynamic Island"
                                        ala iPhone Tecno Spark 20C adalah HP kelas menengah baru yang dirilis.
                                        Produsen smartphone Tecno resmi meluncurkan ponsel murah (entry-level)
                                        terbarunya di pasar global yaitu Tecno Spark 20C. Sesuai namanya, ponsel
                                        ini merupakan penerus dari Tecno Spark 10C yang diperkenalkan sekitar Maret lalu.
                                        Sebagai generasi yang lebih anyar, Tecno Spark 20C hadir dengan pembaruan lubang
                                        kamera alias punch hole yang terletak di tengah atas layar. Sebelumnya, Tecno Spark 10C
                                        masih menggunakan "poni" konvensional bergaya ala tetesan air (waterdrop). Berkat punch hole,
                                        Tecno Spark 20C bisa dibekali dengan fitur poni dinamis yang mirip dengan fitur Dynamic Island
                                        di iPhone 14 Pro. Poni tersebut diberi nama Dynamic Port dan dapat berubah ukuran menyesuaikan
                                        aktivitas pengguna. Dengan Dynamic Port, lubang punch hole nantinya akan berubah memanjang ke
                                        kanan dan kiri ketika menerima notifikasi panggilan masuk, menunjukkan status baterai, dan
                                        sebagainya. 
                                    </p>
